...
$user_role = $_SESSION['role'] ?? 'Volunteer';
$body_class = 'role-volunteer';
$root = (strpos($_SERVER['PHP_SELF'] ?? '', '/test2/') === 0) ? '/test2/' : '/';
$path_prefix = '../';
require_once '../includes/header.php';

// Colors (New premium calming forest green palette)
$primary_color = '#2D6A4F';
$accent_color  = '#1B4332';
$light_bg      = '#F4F9F5';
$card_shadow = '0 10px 40px rgba(45, 106, 79, 0.08)';
...
<style>
    :root {
        --about-primary: <?php echo $primary_color; ?>;
        --about-accent: <?php echo $accent_color; ?>;
        --about-light: <?php echo $light_bg; ?>;
    }
